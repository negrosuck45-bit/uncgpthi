...
function initializeVisitorCounter() {
    const initialVisitors = 50;
    const maxAllowedVisitors = 1000;
    let totalVisitors = initialVisitors;
    
    const storedVisitors = parseInt(localStorage.getItem('totalVisitorCount'), 10);
    if (!Number.isNaN(storedVisitors) && storedVisitors >= initialVisitors && storedVisitors <= maxAllowedVisitors) {
      totalVisitors = storedVisitors;
    }
    
    // Increment by 1 for this page view/visit
    totalVisitors += 1;
